...
for i = 1 : nblocks
    ...
    blockdata = load(fullfile(paths.sorted_data, blocks{i}, 'SPIKE.mat'));
    blockdata = blockdata.blockdata;
    nclu = numel(blockdata.SPIKES.spikes);
    
    
    rfdata = load(fullfile(paths.rfquality, blocks{i}, 'fitresulto.mat'));
    ...
    for j = 1: nclu
        ...
        auxdata = load(fullfile(paths.neurons_data, blocks{i}, strcat('NEURON_', num2str(j)) ));
...
filename = fullfile(pars.paths.dropbox, 'I.mat');
save(filename, 'I')
